...
dataFilename = '20140730_Test_17.txt';
rcm.initial.P = 0.798;     % bar
rcm.initial.T = 298.25;     % K
rcm.bool_sampling = 1;      % 0 is corresponding to without sampling  
rcm.sampling.delay = 20;	% ms
rcm.config = '10';          % mm
...
rcm.lookup.TDC.begin_upper = 0.4956*10^5;   
...
rcm.lookup.TDC.finish_upper = 0.5138*10^5;      
...
rcm.Molar = struct(...
    'O2',6/Molar_SUM , ...
    'N2',6*7.26*2/5/Molar_SUM , ...
    'Ar',6*7.26*3/5/Molar_SUM , ...
    'H2',0, ...
    'CO2',0, ...
    'CO',0,...
    'H2O',0, ...
